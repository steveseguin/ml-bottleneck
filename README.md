...
- 🪜 **Ceiling ladder**: hardware ceiling → engine model → expected real → nearest measured run (plus the [neural.download](https://neural.download/) lab's tuned result on Intel Arc Pro), so predictions never overpromise past physics
